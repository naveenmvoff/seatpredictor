      ...
      try {
        ...
        if (data.system_settings) {
          setDataSourcePriority(
            data.system_settings.data_source_priority || "specific"
          );
          setAutomaticBackup(data.system_settings.automatic_backup || true);
          setEmailNotifications(
            data.system_settings.email_notifications || true
          );
        }
      } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <p className="text-gray-600 text-sm mb-6">
          Set the active year for each exam type. Only one year can be active
          per exam.
        </p>
            ...
            <div className="space-y-3">
              {neetPgYears.map((yearData) => (
                <div
                  ...
                  onClick={() =>
                    setActiveYear("NEET-PG", yearData.year.toString())
                  }
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
            ...
            <div className="space-y-3">
              {neetSsYears.map((yearData) => (
                <div
                  ...
                  onClick={() =>
                    setActiveYear("NEET-SS", yearData.year.toString())
                  }
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            ...
            <div className="text-xs text-purple-700">Available data years</div>
          </div>
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
            ...
            <div className="text-xs text-orange-700">Currently active</div>
          </div>
        </div>
      </div>
    </div>
