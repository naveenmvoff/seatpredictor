...
export default function DataUpload() {
  ...
  const handleUpload = async () => {
    if (!selectedFile) {
      ...
      setUploadMessage(
        "Please select exam type, year, and file before uploading."
      );
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Import Excel/CSV files for NEET exams
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <p className="text-gray-600 text-sm mb-4">
          Download a sample Excel file with the required headers.
        </p>
        <a
          href="/templates_file/example_upload.xlsx"
          download
          className="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 flex items-center gap-2 inline-flex"
        >
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <p className="text-gray-600 text-sm mb-6">
          Select exam type, year, and upload your Excel or CSV file
        </p>
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  onClick={() => {
                    ...
                    const csvContent = validationErrors
                      .map(
                        (error) => `${error.row},${error.field},${error.error}`
                      )
                      .join("\n");
